...
| P1 operations/admin | 🟢 | Allowlisted users get an operator desk section in My trips. |
...
- GitHub Actions run #163 passed `npm ci`, domain tests, typecheck, lint, build and production smoke — **VERIFIED**.
