...
export const Route = createFileRoute("/$locale/destinations/")({
  ...
  head: ({ params }) => {
    ...
    return seoHead({ locale, title: siteCopy(locale, "metaPlacesTitle"), description: siteCopy(locale, "metaPlacesDescription"), pathname: `/${params.locale}/destinations`, alternatePathname: (l) => `/${l}/destinations` });
  },
